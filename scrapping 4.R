...
stop.words <- read.table("https://raw.githubusercontent.com/stopwords-iso/stopwords-cs/master/stopwords-cs.txt")$V1
# tady jsem začal přidávat další stopwords, které vydím v textu
removeWords <- c(stopwords, "jej", "i", "takového")
